...
class Mongodb_Autoincrement {
    ...
    private $_counterCollectionName;
    private $_collectionName;
    private $_dbName;
    
    public function __construct($collectionName, $dbName = "masterdb_take1", $counterCollectionName) {
        $this->_collectionName = $collectionName;
        $this->_dbName = $dbName;
        $this->_counterCollectionName=$counterCollectionName;
    }
